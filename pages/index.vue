  ...
  <div class="container mx-auto px-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <img src="/assets/FC.jpg" alt="Service Image" class="w-full h-48 object-cover">
        <div class="p-6">
          <h3 class="text-xl text-center font-semibold mb-2">Sunday Worship</h3>
          <p class="text-gray-600">Timing: 10:00 AM - 12:00 PM</p>
        </div>
      </div>

      <!-- Card 2 -->
      <div class="bg-white rounded-lg shadow-md overflow-hidden">
        <img src="/assets/Daddy-G.webp" alt="" class="w-full h-24 object-cover">
        <div class="p-6">
          <h3 class="text-xl text-center font-semibold mb-2">Sunday Worship</h3>
          <p class="text-gray-600">Timing: 10:00 AM - 12:00 PM</p>
        </div>
